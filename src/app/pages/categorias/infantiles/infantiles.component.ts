...
@Component({
  ...
  styleUrls: ['./infantiles.component.css']
})
export class InfantilesComponent implements OnInit {
  ...
  estaBuscando = false;
  buscar = '';
  urlBaseBusqueda = 'http://localhost:8080/api/productos/infantiles/busqueda6';
  urlBase = 'http://localhost:8080/api/productos/infantiles';
  url = 'http://localhost:8080/api/productos/infantiles';
